...
#include "teamData.h"
#include "teamSpecialKey.h"
#include "AvlTree.h"
#include "RankTree.h"
#include "HashTable.h"
//#include "HashTablexx.h"
class world_cup_t {
private:
    //HashTable<PlayerData*>* allPlayers;
    HashTable* allPlayers;
    Tree<int,TeamsData>* avlTreeTeams;
    RankTree<teamSpecialID,TeamsData>* teamsByPower;
    PlayerData* findPlayerAndUnion(int playerID);
public:
	// <DO-NOT-MODIFY> {
